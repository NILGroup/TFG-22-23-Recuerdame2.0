...
<div class="row form-group justify-content-between">
    <div class="row col-sm-12 col-md-6 col-lg-6 align-items-center">
        <label for="telefono" class="form-label col-form-label negrita col-sm-12 col-md-5 col-lg-3">Teléfono:</label>
        <div class="col-sm-12 col-md-6 col-lg-8 align-items-center">
...
<div class="row form-group justify-content-between">
    <div class="row col-sm-12 col-md-6 col-lg-6 align-items-center">
        <label for="fecha" class="form-label col-form-label negrita col-sm-12 col-md-5 col-lg-3">Correo:</label>
        <div class="col-sm-12 col-md-6 col-lg-8 align-items-center">
