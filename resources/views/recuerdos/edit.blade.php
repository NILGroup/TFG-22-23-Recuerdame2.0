    ...
    <input type="hidden" name="id" id="id" value="{{$recuerdo->id}}">
            ...
            <div class="row col-sm-6 col-md-6 col-lg-6">
                ...
                <div class="col-sm-9 col-md-6 col-lg-4">
                    <select class="form-select form-select-sm" id="idEstado" name="estado_id">
                        ...
                        @if($estado->id == $recuerdo->estado_id)
                        <option selected="true" value="{{$estado->id}}">{{$estado->nombre}}</option>
                        @else
        ...
        <div class="row justify-content-between">
            <div class="row col-sm-6 col-md-6 col-lg-6">
                ...
                <div class="col-sm-9 col-md-6 col-lg-4">
                    <input type="date" class="form-control form-control-sm" id="fecha" name="fecha" value="{{$recuerdo->fecha}}">
                </div>
            </div>
            <div class="row col-sm-6 col-md-6 col-lg-6">
                ...
                <div class="col-sm-9 col-md-6 col-lg-4">
                    <select class="form-select form-select-sm" id="idEtiqueta" name="etiqueta_id">
                        ...
                        @if($etiqueta->id == $recuerdo->etiqueta_id)
                        <option selected="true" value="{{$etiqueta->id}}">{{$etiqueta->nombre}}</option>
                        @else
        ...
        <div class="row">
            <div class="row col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="col-sm-5 col-md-5 col-lg-3">
                    <input type="range" class="form-range puntuacion" id="puntuacion" name="puntuacion" min="0" max="10" step="1" value="{{$recuerdo->puntuacion}}">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-3 col-md-3 col-lg-2">
                    <select class="form-select form-select-sm" id="idEmocion" name="emocion_id">
                        ...
                        @if($etiqueta->id == $recuerdo->etiqueta_id)
                        <option selected="true" value="{{$emocion->id}}">{{$emocion->nombre}}</option>
                        @else
