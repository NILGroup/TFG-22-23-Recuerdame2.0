...
<div class="col-lg-3 align-items-center" style="padding-right: 10px!important;">
...
<div class="row form-group justify-content-between">
    <div class="row col-sm-12 col-md-6 col-lg-4 align-items-center">
        <label for="nombre" class="form-label col-form-label col-sm-12 col-md-6 col-lg-6 negrita">Nombre:<span class="asterisco">*</span></label>
    ...
    <div class="row col-sm-12 col-md-6 col-lg-7 align-items-center">
        <label for="apellidos" class="form-label col-form-label col-sm-12 col-md-5 col-lg-3 negrita">Apellidos:<span class="asterisco">*</span></label>
...
<div class="row form-group justify-content-between ">
    <div class="row col-sm-12 col-md-6 col-lg-4 align-items-center">
        <label for="telefono" class="form-label col-form-label col-sm-12 col-md-6 col-lg-6 negrita">Teléfono:</label>
        <div class="col-sm-12 col-md-6 col-lg-6 ">
            <input type="tel" pattern="[0-9]{9}" name="telefono" class="form-control form-control-sm" id="telefono" value="{{$persona->telefono}}" >
        </div>
    </div>
    <div class="row col-sm-12 col-md-6 col-lg-7 align-items-center">
        <label for="ocupacion" class="form-label col-form-label negrita col-sm-12 col-md-5 col-lg-3">Ocupación:<span class="asterisco">*</span></label>
        <div class="col-sm-12 col-md-6 col-lg-8 ">
...
<div class="row form-group justify-content-between">
    <div class="row col-sm-12 col-md-6 col-lg-4 align-items-center">
        <label for="email" class="form-label col-form-label negrita col-sm-12 col-md-6 col-lg-6">Email:<span class="asterisco">*</span></label>
        <div class="col-sm-12 col-md-6 col-lg-6">
            <input type="email" name="email" class="form-control form-control-sm" id="email" value="{{$persona->email}}" required >
        </div>
    </div>
    <div class="row col-sm-12 col-md-6 col-lg-7 align-items-center">
        <label for="localidad" class="form-label col-form-label negrita col-sm-12 col-md-5 col-lg-3">Localidad:<span class="asterisco">*</span></label>
        <div class="col-sm-12 col-md-6 col-lg-8 ">
...
<div class="row form-group justify-content-between" >
    <div class="row col-sm-12 col-md-6 col-lg-4 align-items-center">
        <label for="tipo" class="form-label col-form-label negrita col-sm-12 col-md-6 col-lg-6">Tipo de relación:<span class="asterisco">*</span></label>
    ...
    <div class="row col-sm-12 col-md-6 col-lg-7 align-items-center">
        <label for="contacto" class="form-label col-form-label negrita col-sm-12 col-md-5 col-lg-3" >Contacto: <i class="bi bi-question-circle" data-toggle="tooltip" data-placement="top" title="Indicar si se trata del contacto preferente para este usuario."></i><span class="asterisco">*</span></label>
        <div class="col-sm-12 col-md-6 col-lg-8">
...
<div class="row form-group justify-content-between" style="margin-right: 50px!important;" >
    <div class="mb-3 mt-3">
