...
INSERT INTO sesions (id, titulo, fecha, objetivo, descripcion, fecha_finalizada, respuesta, barreras, acciones, facilitadores, observaciones, duracion, paciente_id, user_id, etapa_id, participacion_id, complejidad_id, finalizada, deleted_at) VALUES
(1, 'Trabajar infancia', '2023-03-01 15:30:00', 'Trabajar los recuerdos de su infancia como toma de contacto.', NULL, '2023-03-05 12:00:00', 'Gestiona las emociones correctamente.', 'Algunos recuerdos ya no conservados.', 'Presentarse a María Concepción.\r\n            Realizar CDR, Mental y GDS para el diagnóstico.\r\n            Hacer preguntas para evocar recuerdos y emociones.\r\n            Mostrarle fotos de los recuerdos.\r\n            Intentar profundizar.', 'El recuerdo con sus amigos', 'ninguna observacion', '01:30', 1, 1, 1, 1, 1, 1, NULL),
(2, 'Trabajar recuerdos actuales', '2023-03-09 10:15:00', 'Intentar recordar sucesos recientes para ver si es capaz de retenerlos', NULL, '2023-03-09 11:10:00', 'Se mostraba bastante participativa, aunque le costase recordar algunas cosas.', NULL, '- Hablar de lo sucedido en la última semana\r\n- Mostrarle los recuerdos desde inicio de año\r\n- Profundizar en aquellos que más emociones generen.', 'Volver a ver la ecografía hizo que se le saltasen las lágrimas de alegría y empezase a hablar más', 'Sería conveniente reevaluar su estado en el próximo informe de seguimiento', '02:30', 1, 1, 5, 2, NULL, 1, NULL),
(3, 'Inicio terapia', '2023-03-04 10:30:00', 'Pruebas iniciales', 'Iniciaremos la terapia como un repaso general', NULL, NULL, NULL, NULL, 'Las fotografías ayudan.', NULL, NULL, 2, 4, 2, NULL, NULL, 0, NULL),
(4, 'Tratar su entrada en la universidad', '2023-03-29 12:00:00', 'Realizar una sesión rápida recordando su primer día en la universidad', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 3, NULL, NULL, 0, NULL);
