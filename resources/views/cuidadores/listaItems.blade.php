...
<div class="row form-group justify-content-between">
    <div class="row col-sm-12 col-md-6 col-lg-6 align-items-center">
        <label for="nick" class="form-label col-form-label negrita col-sm-12 col-md-5 col-lg-3">Nombre:<span class="asterisco">*</span></label>
    ...
    <div class="row col-sm-12 col-md-6 col-lg-6 align-items-center">
        <label for="apellidos" class="form-label col-form-label negrita col-sm-12 col-md-5 col-lg-4">Apellidos:<span class="asterisco">*</span></label>
        <div class="col-sm-12 col-md-6 col-lg-8 align-items-center">
...
<div class="row form-group justify-content-between">
    <div class="row col-sm-12 col-md-6 col-lg-6 align-items-center">
        <label for="telefono" class="form-label col-form-label negrita col-sm-12 col-md-5 col-lg-3">Teléfono:<span class="asterisco">*</span></label>
        <div class="col-sm-12 col-md-6 col-lg-8 align-items-center">
    ...
    <div class="row col-sm-12 col-md-6 col-lg-6 align-items-center">
        <label for="localidad" class="form-label col-form-label negrita col-sm-12 col-md-5 col-lg-4">Localidad:</label>
        <div class="col-sm-12 col-md-6 col-lg-8 align-items-center">
...
<div class="row form-group justify-content-between">
    <div class="row col-sm-12 col-md-6 col-lg-6 align-items-center">
        <label for="fecha" class="form-label col-form-label negrita col-sm-12 col-md-5 col-lg-3">Correo:<span class="asterisco">*</span></label>
        <div class="col-sm-12 col-md-6 col-lg-8 align-items-center">
    ...
    <div class="row col-sm-6 col-md-6 col-lg-6 align-items-center">
        <label for="parentesco" class="form-label col-form-label negrita col-sm-12 col-md-5 col-lg-4">Parentesco:</label>
        <div class="col-sm-12 col-md-6 col-lg-8 align-items-center">
...
<div class="row form-group justify-content-between">
    <div class="row col-sm-12 col-md-6 col-lg-6 align-items-center">
        <label for="terapeuta" class="form-label col-form-label negrita col-sm-12 col-md-5 col-lg-3">Usuario:<span class="asterisco">*</span></label>
        <div class="col-sm-12 col-md-6 col-lg-8 align-items-center">
    ...
    <div class="row col-sm-12 col-md-6 col-lg-6 align-items-center">
        <label for="pais" class="form-label col-form-label negrita col-sm-12 col-md-5 col-lg-4">Contraseña:<span class="asterisco">*</span></label>
        <div class="col-sm-12 col-md-6 col-lg-8 align-items-center">
