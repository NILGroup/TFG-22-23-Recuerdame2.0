...
<div class="container-fluid" style="height: 75%">
    ...
    <div id="carouselPrincipal" style="height: 85%" class="carousel carousel-dark slide"  data-bs-ride="true">

        <div class="carousel-indicators">
            <?php $l = 0; ?>
            @foreach($listaRecuerdos as $recuerdo)
            @if($l==0)
            <button type="button" data-bs-target="#carouselPrincipal" data-bs-slide-to=<?php echo  $l ?> class="active" aria-label="Slide <?php echo  $l ?>" aria-current="true"></button>
            @else
            <button type="button" data-bs-target="#carouselPrincipal" data-bs-slide-to=<?php echo  $l ?> aria-label="Slide <?php echo  $l ?>" class=""></button>
            ...
            <div class="hv-box p-4">
                ...
                <div class="carousel-item active">
                    <div class="d-block w-100">
                        <div>
                            <h4 class="text-center hv-title"><?php echo $recuerdo->nombre ?></h4>
