<div>
    ...
    <div class="d-flex flex-row justify-content-start  align-items-center" >
        ...
        <div class="col p-2" >
            <input type="date" style="width: fit-content;" class="form-control form-control-sm" id="fecha" name="fecha" value="{{$evaluacion->fecha}}" required @if($show) disabled @endif>
        </div>
    </div>
    <div class="row ">
    ...
    <div class="row">
        <label for="GDS" class="col form-label col-form-label-sm col-sm-2 col-md-2 col-lg-2" style="min-width: 100px;">GDS<span class="asterisco">*</span></label>
    ...
    <div class="row">
        <label for="Mental" class="col form-label col-form-label-sm col-sm-2 col-md-2 col-lg-2" style="min-width: 100px;">Mini mental/MEC de Lobo<span class="asterisco">*</span></label>
        <div class="col col-sm-2 col-md-2 col-lg-2">
    ...
    <div class="row">
        <label for="CDR" class="col form-label col-form-label-sm col-sm-2 col-md-2 col-lg-2" style="min-width: 100px;">CDR<span class="asterisco">*</span></label>
        <div class="col col-sm-2 col-md-2 col-lg-2">
    ...
    @if(!$show || !is_null($evaluacion->nombre_escala))
        ...
        <div class="row">
            <div class="col col-sm-2 col-md-2 col-lg-2">
                    <input type="text" class="col form-control form-control-sm escalaPersonalizada" id="nombre_escala" name="nombre_escala" value="{{$evaluacion->nombre_escala}}" @if($show) disabled @endif >
            </div>
            <div class="col col-sm-2 col-md-2 col-lg-2">
                    <input type="number" class="col form-control form-control-sm escalaPersonalizada" id="escala" name="escala" value="{{$evaluacion->escala}}" @if($show) disabled @endif >
            </div>
            <div class="col col-sm-3 col-md-2 col-lg-2">
