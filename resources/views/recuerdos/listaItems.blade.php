...
<div class="row justify-content-start">
    <div class="row col-sm-6 col-md-5 col-lg-4 align-items-center">
        <label for="apto" class="form-label col-form-label negrita col-sm-5 col-md-4 col-lg-3">Apto: <i class="bi bi-question-circle" data-toggle="tooltip" data-placement="right" title="Marca esta opción si el recuerdo sigue siendo apto para trabajar con él."></i></label>
        <div class="col-sm-7 col-md-2 col-lg-5 align-items-center">
