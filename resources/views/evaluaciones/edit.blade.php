...
<div class="container-fluid">
    ...
    {{csrf_field()}}
        <div>
            <input type="hidden" class="form-control form-control-sm" id="fecha" name="id" value="{{$evaluacion->id}}" required>
            ...
            <div class="row">
                ...
                <div class="col-sm-9 col-md-6 col-lg-2">
                    <input type="date" class="form-control form-control-sm" id="fecha" name="fecha" value="{{$evaluacion->fecha}}" required>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-sm-9 col-md-6 col-lg-2">
                        <input type="number" min="1" max="7" class="form-control form-control-sm" id="gds" name="gds" value="{{$evaluacion->gds}}" required>
        
                </div>
                <div class="col-sm-9 col-md-6 col-lg-2">
                    <input type="date" class="form-control form-control-sm" id="gds_fecha" name="gds_fecha" value="{{$evaluacion->gds_fecha}}" required>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-9 col-md-6 col-lg-2">
                        <input type="number" min="0" max="25" class="form-control form-control-sm" id="mental" name="mental" value="{{$evaluacion->mental}}" required>
                </div>
                <div class="col-sm-9 col-md-6 col-lg-2">
                    <input type="date" class="form-control form-control-sm" id="mental_fecha" name="mental_fecha" value="{{$evaluacion->mental_fecha}}" required>
                </div>
            </div>
            <div class="row">
                <label for="CDR" class="form-label col-form-label-sm col-sm-3 col-md-2 col-lg-2">CDR<span class="asterisco">*</span></label>
                <div class="col-sm-9 col-md-6 col-lg-2">
                        <input type="number" min="0" max="3" class="form-control form-control-sm" id="cdr" name="cdr" value="{{$evaluacion->cdr}}" required>
                </div>
                <div class="col-sm-9 col-md-6 col-lg-2">
                    <input type="date" class="form-control form-control-sm" id="cdr_fecha" name="cdr_fecha" value="{{$evaluacion->cdr_fecha}}" required>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-9 col-md-6 col-lg-2">
                        <input type="text" class="form-control form-control-sm escalaPersonalizada" id="nombre_escala" name="nombre_escala" value="{{$evaluacion->nombre_escala}}" >
                </div>
                <div class="col-sm-9 col-md-6 col-lg-2">
                        <input type="number" class="form-control form-control-sm escalaPersonalizada" id="escala" name="escala" value="{{$evaluacion->escala}}" >
                </div>
                <div class="col-sm-9 col-md-6 col-lg-2">
                    <input type="date" class="form-control form-control-sm escalaPersonalizada" id="fecha_escala" name="fecha_escala" value="{{$evaluacion->fecha_escala}}" >
                </div>
            </div>
