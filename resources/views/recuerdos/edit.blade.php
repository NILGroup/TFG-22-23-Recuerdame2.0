        ...
        <form  method="post" action="/pacientes/{{$paciente->id}}">
            ...
            <div class="row form-group justify-content-between">
                <div class="row col-sm-12 col-md-6 col-lg-5">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <input type="text" name="nombre" class="form-control form-control-sm" id="nombre" value="{{$paciente->nombre}}">
                        {{csrf_field()}}
                ...
                <div class="row col-sm-12 col-md-6 col-lg-7">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-8">
                        <input type="apellidos" name="apellidos" class="form-control form-control-sm" id="apellidos" value="{{$paciente->apellidos}}">
                    </div>
                </div>
            </div>
            ...
            <div class="row form-group justify-content-between">
                ...
                <div class="row col-sm-12 col-md-6 col-lg-7">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-8">
                        <input type="text" name="nacionalidad" class="form-control form-control-sm" id="pais" placeholder="Nacionalidad..." value="{{$paciente->nacionalidad}}">
                    </div>
                </div>
            </div>
