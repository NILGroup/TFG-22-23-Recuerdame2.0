    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="cuidadorExistenteLabel">Cuidadores existentes</h5>
                        ...
                        @foreach($cuidadoresTerapeuta as $cuidador)
                            <tr>
                                ...
                                <td id="personasSeleccionadas" class="tableActions">
                                    <input class="form-check-input" type="checkbox" value="{{$cuidador->id}}" name="checkCuidador[]" id="checkCuidador">
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="return agregarCuidador();">Finalizar</button>
            </div>
        </div>
    </div>
</div>
