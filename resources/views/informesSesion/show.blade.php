...
<div class="container-fluid">
    ...
    <form action="/generarPDFInformeSesion" method="POST">
        ...
        <div>
            ...
            <a href="/usuarios/{{$paciente->id}}/informesSesion/{{$sesion->id}}/editar"><button type="button" class="btn btn-secondary">Editar</button></a>
            <a href="/usuarios/{{$sesion->paciente_id}}/informesSesion/{{$sesion->id}}/informe" ><button type="button" class="btn btn-outline-primary">Generar PDF</button></a>
        </div>
    </form>
</div>
@endsection
