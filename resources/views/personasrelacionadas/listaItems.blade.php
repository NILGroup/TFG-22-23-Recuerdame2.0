...
<div class="row form-group justify-content-between" >
    ...
    <div class="row col-sm-12 col-md-6 col-lg-7 align-items-center">
        <label for="contacto" class="form-label col-form-label negrita col-sm-12 col-md-12 col-lg-4" >Contacto: <i class="bi bi-question-circle" data-toggle="tooltip" data-placement="top" title="Marcar si actualmente mantiene el contacto con esta persona"></i><span class="asterisco">*</span></label>
        <div class="col-sm-12 col-md-12 col-lg-8 align-items-center">
